...
$description = "Antecedentes y referentes para el diseño de mi portafolio profesional";
...
<li<?php if((basename($_SERVER['PHP_SELF']))=='index.php'){?> class="active" <?php };?>><a href="index.php">Antecedentes y referentes</a></li>
<li<?php if((basename($_SERVER['PHP_SELF']))=='about.php'){?> class="active" <?php };?>><a href="about.php">Portafolio</a></li>
