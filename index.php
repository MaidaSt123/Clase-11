...
<?php
$inspiracion = array_map('str_getcsv', file('data/antecedentes-referentes.csv'));
...
for($n=0; $n < $all; $n++){?>
  ...
  <article>
  <figure>
    <img src="<?php print($inspiracion[$n]["images"])?>">
  ...
  <p><?php print($inspiracion[$n]["abstract"])?>. <a href="post.php?url=<?php print $n;?>">Ver más detalles</a></p>
  </article>
  </div><!--/col-sm-4-->
<?php };?>
</div><!--/row auto-clear-->
